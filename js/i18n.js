...
const dict = {
  zh: {
    ...
    "start.leagueHint": "五国联赛均可执教；每个新生涯必须从所选国家的最低开放级别起步。",
    "start.slots": "存档槽",
    ...
    "clubs.allDiv": "全部级别",
    "clubs.searchPh": "搜索队名…",
    "clubs.hint": "浏览五国全部球队：积分、阵容实力、近期赛程。也可从积分榜或赛程点击队名打开。",
    "clubs.view": "查看",
    ...
    "tac.width": "进攻宽度",
    "tac.defLine": "防线高度",
    "tac.hint": "阵型、风格、滑条与角色指令都会影响攻防、控球、犯规与体能；风格之间存在克制。",
    "tac.pitchHint": "拖拽换人；下方下拉设置角色指令（影响进球/助攻/抢断与整体倾向）。点名牌看资料。",
    "tac.bench": "替补席",
    ...
    "clubIntl.hint": "五国顶级联赛按赛季排名分流至欧冠、欧联和欧协联。新赛季联赛阶段每队 8 场，前 8 名进入淘汰赛。",
    "clubIntl.stage": "阶段",
    ...
    "clubIntl.ratingsHint": "至少 2 场出场 · 本赛事场均评分",
    ...
    "stats.ratingsHint": "至少 3 场出场 · 场均评分",
  ...
  en: {
    ...
    "start.leagueHint": "All five countries are playable. Every new career starts in that country's lowest playable tier.",
    ...
    "clubs.hint": "Browse every club across five countries: table position, squad strength and fixtures. Click a club anywhere to open it.",
    "clubs.view": "View",
    ...
    "tac.hint": "Formation, style, sliders and player roles affect attack/defence, possession, fouls and fitness.",
    "tac.pitchHint": "Drag to swap. Use role dropdown under each player (goals/assists/tackles + team bias). Name opens profile.",
    "tac.bench": "Bench",
    ...
    "clubIntl.hint": "Top-flight finishing positions across the five nations feed the Champions League, Europa League and Conference League. In new seasons, each club plays eight league-phase matches; the top eight advance.",
    ...
    "clubIntl.ratingsHint": "Min 2 apps · competition average rating",
    ...
    "stats.ratingsHint": "Min 3 apps · average rating",

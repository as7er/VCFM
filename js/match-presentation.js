...
export function interpolateSimBall(from = {}, to = {}, alpha = 0) {
  ...
  return {
    ...
    // Contact belongs to its recorded frame, never to an earlier point along
    // the incoming path. The view deduplicates repeated interpolation samples.
    deflect: (t >= 1 ? to.deflect : from.deflect) || null,
  };
}

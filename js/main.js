...
import { nationFlagHtml } from "./flags.js?v=240";
import { clubCrestHtml } from "./club-crest.js?v=240";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=240").then((module) => {
      matchViewApi = module;
      return module;
    });
  }

...
import { nationFlagHtml } from "./flags.js?v=239";
import { clubCrestHtml } from "./club-crest.js?v=239";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=239").then((module) => {
      matchViewApi = module;
      return module;
    });
  }

...
import { nationFlagHtml } from "./flags.js?v=241";
import { clubCrestHtml } from "./club-crest.js?v=241";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=241").then((module) => {
      matchViewApi = module;
      return module;
    });
  }

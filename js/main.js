...
import { nationFlagHtml } from "./flags.js?v=195";
import { clubCrestHtml } from "./club-crest.js?v=195";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=195").then((module) => {
      matchViewApi = module;
      return module;
    });
  }

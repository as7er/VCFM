...
import { nationFlagHtml } from "./flags.js?v=244";
import { clubCrestHtml } from "./club-crest.js?v=244";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=244").then((module) => {
      matchViewApi = module;
      return module;
    });
  }

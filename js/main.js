...
import { nationFlagHtml } from "./flags.js?v=237";
import { clubCrestHtml } from "./club-crest.js?v=237";
...
function loadMatchViewModule() {
  if (!matchViewModulePromise) {
    matchViewModulePromise = import("./matchview.js?v=237").then((module) => {
      matchViewApi = module;
      return module;
    });
  }

...
> 缓存：**vcfm-v160**（门票可见 + 经理再就业/跳槽）

## v160 门票展示与经理职业流动（2026-07-27）

- 门票：赛后新闻/战报写明「门票收入」；概览财政显示最近主场与本季累计；`club.finance.seasonTicketIncome`
- 经理：解雇/请辞进入待业；工作邀请（再就业 / 名望邀请）；接受后切换 `userClubId`，保留生涯统计
- 生涯页：邀请列表、主动请辞、待业推进刷邀请；名望决定邀请档次
- 缓存与入口资源版本同步为 `vcfm-v160`
